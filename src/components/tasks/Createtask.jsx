            ...
            {newTask.participants.map((participant) => (
              <div key={participant.id} className="relative py-5">
                ...
                <IconButton
                  ...
                  className="absolute -top-12 -right-6 bg-gray-500 text-white hover:bg-gray-600"
                  sx={{
                    width: 20,
                    height: 20,
                ...
                <Typography
                  variant="caption"
                  // className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 text-xs text-gray-600"
                >
                  {participant.name}
                </Typography>
              </div>
